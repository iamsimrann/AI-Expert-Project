...
def load_data(file_path='imdb_top_1000.csv'):
    try:
        ...
        print(Fore.YELLOW + f"Warning: The file '{file_path}' was not found. Using sample dataset for demo.")
        sample = {
            'Series_Title': ['The Shawshank Redemption','The Godfather','The Dark Knight','Pulp Fiction','Forrest Gump'],
            'Genre': ['Drama','Crime, Drama','Action, Crime, Drama','Crime, Drama','Drama, Romance'],
            'Overview': [
                'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.',
                'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.',
                'When the menace known as the Joker emerges, he wreaks havoc and chaos on the people of Gotham.',
            ...
            'IMDB_Rating': [9.3,9.2,9.0,8.9,8.8]
        }
